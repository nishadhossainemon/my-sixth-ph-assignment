...
const Card = ({ product, selectedCards, setSelectedCards, totalPrice, setTotalPrice }) => {
  ...
  return (
    <>
      <div className="border-2 border-gray-200 p-5 md:p-6 rounded-2xl text-left hover:shadow-xl transition relative bg-white">
        <span
          className={`absolute top-4 right-4 badge badge-${tagType} text-xs py-3 ${
            tag === "Best Seller"
        ...
        <button
          ...
          className={`btn w-full ${
            btnClicked ? "bg-green-600 hover:bg-green-700" : "bg-purple-500 hover:bg-purple-600"
